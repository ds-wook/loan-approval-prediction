...
class CatBoostTrainer(BaseModel):
    ...
    def _fit(
        ...
        train_set = Pool(X_train, y_train, cat_features=self.cfg.store.cat_features)
        valid_set = Pool(X_valid, y_valid, cat_features=self.cfg.store.cat_features)
...
class LightGBMTrainer(BaseModel):
    ...
    def _fit(
        ...
        train_set = lgb.Dataset(X_train, y_train, categorical_feature=self.cfg.store.cat_features)
        valid_set = lgb.Dataset(X_valid, y_valid, categorical_feature=self.cfg.store.cat_features)
